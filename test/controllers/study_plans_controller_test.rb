...
class StudyPlansControllerTest < ActionController::TestCase
  ...
  test "should create study_plan" do
    assert_difference('StudyPlan.count') do
      post :create, study_plan: { code: @study_plan.code, course_id: @study_plan.course_id, user_id: @study_plan.user_id }
    end
  ...
  test "should update study_plan" do
    patch :update, id: @study_plan, study_plan: { code: @study_plan.code, course_id: @study_plan.course_id, user_id: @study_plan.user_id }
    assert_redirected_to study_plan_path(assigns(:study_plan))
  end
